...
let info =
  [ "project-name", "FsReveal"
    "project-author", "Karlkim Suwanmongkol"
    "project-summary", "FsReveal parses markdown or F# script file and generate reveal.js slides."
    "project-github", githubLink
    "project-nuget", "http://nuget.com/packages/FsReveal" ]
